# -*- coding:utf-8 -*-
# ++++++++++++++++++++++++++++++++++++
# @Time   : 2021/1/14  17:18
# @Author : Ma Xianqin
# @File   : train.py
# @Email  : xianqin.ma@wengegroup.com
# ++++++++++++++++++++++++++++++++++++
import os
import yaml
import argparse
...
def get_args():
    ...
    parser.add_argument('--data_path', type=str, default='/u01/isi/maxq/political/flag/images/',
        ...
        for epoch in range(opt.num_epochs):
            ...
            for iter, data in enumerate(progress_bar):
                ...
                try:
                    ...
                    print('Step: {}. Epoch: {}/{}. Iteration: {}/{}. Cls loss: {:.5f}. Reg loss: {:.5f}. '
                          'Total loss: {:.5f}'.format(step, epoch, opt.num_epochs, iter + 1, num_iter_per_epoch,
            ...
            if epoch % opt.val_interval == 0:
                ...
                print('Val. Epoch: {}/{}. Classification loss: {:1.5f}. Regression loss: {:1.5f}. '
                      'Total loss: {:1.5f}'.format(epoch, opt.num_epochs, cls_loss, reg_loss, loss))
