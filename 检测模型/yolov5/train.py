...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    save_dir, epochs, total_batch_size, weights, rank = \
        Path(opt.save_dir), opt.epochs, opt.total_batch_size, opt.weights, opt.global_rank
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if save:
                ...
                last = wdir / 'train_{}_{}.pt'.format(str(epoch), str(fi))
                torch.save(ckpt, last)
                if best_fitness == fi:
                    best = wdir / 'best_{}_{}.pt'.format(str(epoch), str(fi))
